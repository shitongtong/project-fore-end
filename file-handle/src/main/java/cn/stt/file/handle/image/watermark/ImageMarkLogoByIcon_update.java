 ...
 */
public class ImageMarkLogoByIcon_update {
    ...
    public static void main(String[] args) {
        ...
        // 给图片添加水印
        ImageMarkLogoByIcon_update.markImageByIcon(iconPath, srcImgPath, targerPath);
        // 给图片添加水印,水印旋转-45
        ImageMarkLogoByIcon_update.markImageByIcon(iconPath, srcImgPath, targerPath2, -45);
    }
        ...
        try {
            ...
            if (null != degree) {
                ...
                g.rotate(Math.toRadians(degree),
                        (double) buffImg.getWidth(), (double) buffImg
                                .getHeight());
            }
...
//            g.drawImage(img, 150, 300, null);
            ...
            System.out.println("水印图宽高：" + imgWidth + "," + imgHeight);
            g.drawImage(img, width - imgWidth, height - imgHeight, null);
